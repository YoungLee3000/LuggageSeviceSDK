...
public class ResultState {
    ...
    public static final String PREDICT_BOX_CLOSE = "box_close";
    public static final String PREDICT_BOX_CARRY_RIGHT = "box_carry_right";
    public static final String PREDICT_BOX_CARRY_WRONG = "box_carry_wrong";
